...
class CompletedInvestmentPaid
{
    ...
    /**
     * CompletedInvestmentPaid constructor.
     * @param Investment $investment
     */
    ...
    {
        try {
            MessageSender::send('investment-paid', $this->investment->getUser(), [
                '#INVESTMENT_PAYOUT_AMOUNT#' => Money::formatInNaira($this->investment->getPayoutAmount()),
            ]);
        }
    ...
    {
        try {
            $mailToAdmin = new MessageSenderMail('admin-investment-paid', $this->investment->getUser(), [
                '#INVESTMENT_PAYOUT_AMOUNT#' => Money::formatInNaira($this->investment->getPayoutAmount()),
