...
class LoanApplicationHandleNewAndReady extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'loan:handle-new-and-ready {--users=all}';
     ...
     * @var string
     */
    protected $description = 'Handle Loan Applications with new status and which are ready for processing.';
