		...
		<div id="layerslider" class="grey-bkg" style="width: 100%; height: 500px;">
			<div class="ls-slide" style="slidedirection: right; transition2d: 92,93,105; ">
				<span class="ls-s-1 slider-text" style="slidedirection : top; slideoutdirection : bottom; durationin : 1000; durationout : 1000; ">
					<h1>Get Small Loans <br>Starting From <span class="yellow-text"><b>₦{{}}</b></span></h1>
				</span>
			...
			<div class="ls-slide" data-ls="transition2d:93;">
				<span class="ls-s-1 slider-text" style="slidedirection : top; slideoutdirection : bottom; durationin : 1000; durationout : 1000; ">
					<h1>Access Personal <br>Loans Of <span class="yellow-text"><b>₦3,000,000</b></span></h1>
				</span>
		...
		<div class="home-form">
			<div class="container">
				<div class="row">
					<div class="col-sm-5">
						<!-- the forms switching -->
						<?php include('includes/forms/loan.php'); ?>
						<?php include('includes/forms/name.php'); ?>
						<?php include('includes/forms/employer.php'); ?>
						<?php include('includes/forms/confirm-person.php'); ?>
						<?php include('includes/forms/profile.php'); ?>
						<?php include('includes/forms/financials.php'); ?>
						<?php include('includes/forms/uploads.php'); ?>
						<?php include('includes/forms/done.php'); ?>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="row opt-part">
							...
							<div class="col-xs-9">
								<h5>Upto ₦3,000,000 <span>High Range Loan</span></h5>
							</div>
						</div>
					</div>
					<div class="col-sm-4">
				...
				<div id="myTestimonial" class="carousel slide testimonialz" data-ride="carousel">
				    <div class="carousel-inner">
				      	<div class="item active">
				      		<img src="assets/images/testimonial/user.jpg" class="img-responsive">
					        <h4 class="white-text">I get to apply my preferred loan tenor, and choose how my repayment should be spread across active months! Nice, nice...</h4>
